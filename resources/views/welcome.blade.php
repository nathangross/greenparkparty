                ...
                @if ((isset($publicRsvps) && $publicRsvps->isNotEmpty()) || (isset($privateAttendingCount) && $privateAttendingCount > 0))
                    <div class="mx-auto flex max-w-3xl flex-col gap-6 py-8">
                        ...
                        <div
                            ...
                            class="grid gap-4"
                        >
                            <div class="mx-auto flex w-full max-w-3xl flex-wrap justify-center gap-3 text-left">
                            @if (isset($publicRsvps))
                                @foreach ($publicRsvps as $rsvp)
                                    ...
                                    <div
                                        ...
                                        class="w-full min-w-0 max-w-sm rounded-lg bg-white/70 px-4 py-3 shadow-sm sm:w-[min(100%,24rem)]"
                                    >
                            ...
                            @if (isset($privateAttendingCount) && $privateAttendingCount > 0)
                                <div class="border-green-dark/10 bg-green-dark/5 w-full min-w-0 max-w-sm rounded-lg border px-4 py-3 sm:w-[min(100%,24rem)]">
                                    <div class="font-bold">
